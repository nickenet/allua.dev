...
=====================================================
 Файл: uslugi.php
-----------------------------------------------------
 Назначение: Дополнительные услуги каталога
=====================================================
*/
      ...
      <tr>
        <td><div id="TabbedPanels1" class="TabbedPanels">
          <ul class="TabbedPanelsTabGroup">
            <li class="TabbedPanelsTab" tabindex="0">Заказать другие услуги каталога</li>
            </ul>
            ...
            <div class="TabbedPanelsContent">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="right" background="<? echo "$def_mainlocation"; ?>/users/template/images/center_r.gif"><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td bgcolor="#EEEEEE">&nbsp;Виды дополнительных услуг:&nbsp;</td>
                        <td width="50">&nbsp;</td>
                      </tr>
                  </table></td>
                ...
                <tr>
                  ...
                  <td class="tb_cont"><? include ('doc/uslugi.php'); ?></td>
                  <td width="3" background="<? echo "$def_mainlocation"; ?>/users/template/images/left_right_r.gif"><img src="<? echo "$def_mainlocation"; ?>/users/template/images/left_right_r.gif" width="3" height="1"></td>
                </tr>
                <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="right" background="<? echo "$def_mainlocation"; ?>/users/template/images/center_r.gif"><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td bgcolor="#EEEEEE">&nbsp;Отправить заявку на подключение услуг:&nbsp;</td>
                        <td width="50">&nbsp;</td>
                      </tr>
                  </table></td>
                  <td width="3"><img src="<? echo "$def_mainlocation"; ?>/users/template/images/right_r.gif" width="3" height="30"></td>
...
<input type="hidden" name="support_type" value="uslugi">
<textarea name="tosupport" id="textarea_main" cols="30" rows="10" onfocus="document.getElementById('u_but').style.visibility='visible'" style="font size:10px; width:417px; height:150px;">Перечислите услуги, которые Вы бы хотели заказать.</textarea><br />
<input type="submit" id="u_but" value="Отправить" style="visibility: hidden" />
</FORM>
                  </td>
                  <td width="3" background="<? echo "$def_mainlocation"; ?>/users/template/images/left_right_r.gif"><img src="<? echo "$def_mainlocation"; ?>/users/template/images/left_right_r.gif" width="3" height="1"></td>
                </tr>
