...
{
	$('#themeConfig').before('<link href="informer_load.php?css_only=1&'+ locStr +'" type="text/css" rel="Stylesheet" />');
	if($("link[href*=informer_load\\.php]").size() > 3)
	{
		$("link[href*=informer_load\\.php]:first").remove();
	}
